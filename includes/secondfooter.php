<footer class="page-footer">
         ...
         <div class="footer-copyright">
           ...
           <a class="grey-text text-lighten-4 right animated slideInUp wow" href="#">Made with <i class="fa fa-heartbeat animated pulse infinite red-text"></i> By Sailaja Nandan</a>
           </div>
         </div>
       </footer>
